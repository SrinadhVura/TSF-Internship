This task is the simplest of all which involves the building of a simple Linear regressor model with one dependent column (Score) and one independent column (Hours).
